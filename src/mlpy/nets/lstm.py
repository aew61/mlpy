...
class lstm(basernn.BaseRNN):
    ...
    def _train_return_errors(self, X, Y):
        self.reset()
        dLdF, dLdI, dLdC, dLdHf, dLdO, dLdX = self.back_propagate_through_time(X[i], Y[i])
        dLdXs.append(dLdX)
